...
""" + "\n".join(fp(*x) for x in footprints) + """
  ...
  (segment (start 51.3575 50.2750) (end 55.5000 50.2750) (width 0.25) (layer "F.Cu") (net 22))\n  (segment (start 55.5000 50.2750) (end 56.9632 56.0000) (width 0.25) (layer "F.Cu") (net 22))\n  (segment (start 56.9632 56.0000) (end 56.9632 75.6576) (width 0.25) (layer "F.Cu") (net 22))
