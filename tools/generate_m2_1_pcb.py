...
""" + "\n".join(fp(*x) for x in footprints) + """
  ...
  (via (at 60.8000 48.0000) (size 0.7) (drill 0.35) (layers "F.Cu" "B.Cu") (net 2))\n  (segment (start 58.5000 45.0750) (end 60.0000 44.0000) (width 0.30) (layer "B.Cu") (net 2))\n  (segment (start 60.0000 44.0000) (end 66.5000 44.0000) (width 0.30) (layer "B.Cu") (net 2))\n  (segment (start 58.5000 47.0250) (end 60.0000 46.5000) (width 0.30) (layer "B.Cu") (net 2))\n  (segment (start 60.0000 46.5000) (end 66.5000 46.5000) (width 0.30) (layer "B.Cu") (net 2))\n  (segment (start 59.0000 48.3000) (end 60.0000 49.5000) (width 0.30) (layer "B.Cu") (net 2))\n  (segment (start 60.0000 49.5000) (end 66.5000 49.5000) (width 0.30) (layer "B.Cu") (net 2))\n  (segment (start 66.5000 44.0000) (end 66.5000 49.5000) (width 0.30) (layer "B.Cu") (net 2))
