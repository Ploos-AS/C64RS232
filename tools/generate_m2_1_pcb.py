...
""" + "\n".join(fp(*x) for x in footprints) + """
  ...
  (segment (start 60.0000 38.0000) (end 60.0000 49.0000) (width 0.40) (layer "F.Cu") (net 2))
  (segment (start 57.0825 45.0750) (end 60.0000 45.0750) (width 0.30) (layer "F.Cu") (net 2))
  (segment (start 57.0825 47.0250) (end 60.0000 47.0250) (width 0.30) (layer "F.Cu") (net 2))
  (segment (start 57.0825 47.6750) (end 60.0000 47.6750) (width 0.30) (layer "F.Cu") (net 2))
  (segment (start 59.9625 47.5000) (end 60.0000 47.5000) (width 0.30) (layer "F.Cu") (net 2))
