...
""" + "\n".join(fp(*x) for x in footprints) + """
  ...
  (via (at 66.5000 43.0000) (size 0.8) (drill 0.4) (layers "F.Cu" "B.Cu") (net 2))
  (segment (start 66.5000 41.0000) (end 66.5000 43.0000) (width 0.40) (layer "F.Cu") (net 2))
  (segment (start 66.5000 43.0000) (end 66.5000 45.0750) (width 0.40) (layer "B.Cu") (net 2))
