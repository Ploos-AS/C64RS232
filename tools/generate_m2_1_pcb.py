...
""" + "\n".join(fp(*x) for x in footprints) + """
  ...
  (segment (start 49.5000 43.7750) (end 47.0000 43.5000) (width 0.20) (layer "F.Cu") (net 6))\n  (segment (start 47.0000 43.5000) (end 45.9625 44.1000) (width 0.20) (layer "F.Cu") (net 6))
