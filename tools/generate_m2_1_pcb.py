...
""" + "\n".join(fp(*x) for x in footprints) + """
  ...
  (segment (start 51.3575 45.7250) (end 45.5000 49.0000) (width 0.25) (layer "F.Cu") (net 19))\n  (segment (start 45.5000 49.0000) (end 45.5000 54.0000) (width 0.25) (layer "F.Cu") (net 19))\n  (segment (start 45.5000 54.0000) (end 46.0000 55.0000) (width 0.25) (layer "F.Cu") (net 19))\n  (segment (start 46.0000 55.0000) (end 46.0000 70.0000) (width 0.25) (layer "F.Cu") (net 19))\n  (segment (start 46.0000 70.0000) (end 51.4768 75.6576) (width 0.25) (layer "F.Cu") (net 19))
