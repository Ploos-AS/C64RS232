...
""" + "\n".join(fp(*x) for x in footprints) + """
  ...
  (segment (start 57.0825 45.7250) (end 57.6000 45.7250) (width 0.25) (layer "F.Cu") (net 3))
  (segment (start 57.6000 45.7250) (end 57.6000 46.2000) (width 0.25) (layer "F.Cu") (net 3))
  (via (at 57.6000 46.2000) (size 0.7) (drill 0.35) (layers "F.Cu" "B.Cu") (net 3))
