...
""" + "\n".join(fp(*x) for x in footprints) + """
  ...
  (segment (start 57.0825 47.0250) (end 59.2000 46.7000) (width 0.25) (layer "F.Cu") (net 2))\n  (via (at 59.2000 46.7000) (size 0.7) (drill 0.35) (layers "F.Cu" "B.Cu") (net 2))
  ...
  (segment (start 59.2000 46.7000) (end 57.5000 40.0000) (width 0.30) (layer "B.Cu") (net 2))
