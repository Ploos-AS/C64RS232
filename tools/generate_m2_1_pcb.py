...
""" + "\n".join(fp(*x) for x in footprints) + """
  ...
  (segment (start 51.3575 45.0750) (end 50.5000 44.7000) (width 0.20) (layer "F.Cu") (net 9))
  (segment (start 50.5000 44.7000) (end 47.0000 44.7000) (width 0.20) (layer "F.Cu") (net 9))\n  (segment (start 47.0000 44.7000) (end 45.9625 46.5000) (width 0.20) (layer "F.Cu") (net 9))
