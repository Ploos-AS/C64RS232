...
""" + "\n".join(fp(*x) for x in footprints) + """
  ...
  (segment (start 51.3575 46.3750) (end 45.0000 53.0000) (width 0.25) (layer "F.Cu") (net 21))\n  (via (at 45.0000 53.0000) (size 0.70) (drill 0.35) (layers "F.Cu" "B.Cu") (net 21))\n  (segment (start 45.0000 53.0000) (end 43.0000 60.0000) (width 0.25) (layer "B.Cu") (net 21))\n  (segment (start 43.0000 60.0000) (end 43.0000 74.0000) (width 0.25) (layer "B.Cu") (net 21))\n  (segment (start 43.0000 74.0000) (end 55.5916 78.5024) (width 0.25) (layer "B.Cu") (net 21))
