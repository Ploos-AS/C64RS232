...
""" + "\n".join(fp(*x) for x in footprints) + """
  ...
  (segment (start 56.2000 23.8100) (end 56.2000 40.0000) (width 0.25) (layer "B.Cu") (net 16))
  (via (at 56.2000 40.0000) (size 0.8) (drill 0.4) (layers "F.Cu" "B.Cu") (net 16))
  (segment (start 56.2000 40.0000) (end 63.5000 50.0000) (width 0.25) (layer "F.Cu") (net 16))
  (segment (start 63.5000 50.0000) (end 65.0000 51.5750) (width 0.25) (layer "F.Cu") (net 16))
