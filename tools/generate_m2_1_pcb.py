...
""" + "\n".join(fp(*x) for x in footprints) + """
  ...
  (segment (start 48.0375 46.5000) (end 49.0000 47.3000) (width 0.20) (layer "F.Cu") (net 3))
  (segment (start 49.0000 47.3000) (end 54.5000 47.3000) (width 0.20) (layer "F.Cu") (net 3))
  (segment (start 54.5000 47.3000) (end 57.0825 45.7250) (width 0.20) (layer "F.Cu") (net 3))
