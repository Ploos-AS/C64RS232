...
""" + "\n".join(fp(*x) for x in footprints) + """
  ...
  (segment (start 51.3575 50.2750) (end 58.5000 54.0000) (width 0.25) (layer "F.Cu") (net 22))\n  (segment (start 58.5000 54.0000) (end 60.0000 56.0000) (width 0.25) (layer "F.Cu") (net 22))\n  (segment (start 60.0000 56.0000) (end 60.0000 70.0000) (width 0.25) (layer "F.Cu") (net 22))\n  (segment (start 60.0000 70.0000) (end 56.9632 75.6576) (width 0.25) (layer "F.Cu") (net 22))
