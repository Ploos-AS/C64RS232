...
""" + "\n".join(fp(*x) for x in footprints) + """
  ...
  (segment (start 44.3200 34.0000) (end 49.0000 52.8000) (width 0.25) (layer "B.Cu") (net 12))
  (segment (start 49.0000 52.8000) (end 51.3575 51.5750) (width 0.25) (layer "F.Cu") (net 12))
  ...
  (via (at 49.0000 52.8000) (size 0.8) (drill 0.4) (layers "F.Cu" "B.Cu") (net 12))
