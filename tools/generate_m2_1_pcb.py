...
""" + "\n".join(fp(*x) for x in footprints) + """
  ...
  (segment (start 51.3575 43.7750) (end 50.0000 43.3000) (width 0.20) (layer "F.Cu") (net 6))
  (segment (start 50.0000 43.3000) (end 47.0000 43.3000) (width 0.20) (layer "F.Cu") (net 6))
  (segment (start 47.0000 43.3000) (end 45.9625 44.1000) (width 0.20) (layer "F.Cu") (net 6))
